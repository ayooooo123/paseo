...
// bare-pack emits a CommonJS module exporting the worker source. Treat the
// compound extension as source so Metro keeps it lazy instead of copying it as
// an opaque asset or eagerly decoding a generated base64 TypeScript literal.
