...
const INBOUND_PERMISSION = {
  ...
  "agent.timeline.subscribe_and_fetch.request": ["workspace.read", "hub.execute"],
...
const OUTBOUND_PERMISSION = {
  ...
  "agent.timeline.subscribe_and_fetch.response": ["workspace.read", "hub.execute"],
  ...
  "project.github.clone.progress": "workspace.manage",
