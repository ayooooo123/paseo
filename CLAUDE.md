...
| [docs/refactors/holepunch-sync-plan.md](docs/refactors/holepunch-sync-plan.md) | Proposed Hypercore, Hyperbee, and Autobase integration; transport recovery, access gates, and rollout                          |
